...
// console.log(newBlogs[4]);
// let humans = [];
// newBlogs.forEach((blog) => {
//   // let temp = [...blog.metadata.significantHoomans];
//   // console.log(JSON.parse(blog.metadata).significantHoomans);
//   JSON.parse(blog.metadata).significantHoomans.forEach((person) => {
//     humans.push(person);
//   });
// });

// let temp = new Set(humans);
// const final = [...temp];
// console.log(final);
...
async function runMigration() {
  ...
  //   const category = categories.find((cat) => cat.title === blog.category);

  //   if (!category) {
  //     console.log(`No category found for blog ${blog._id}`);
  //     continue;
  //   }
...
async function savePokemonData() {
  ...
  for (let i = 251; i <= 500; i++) {
    try {
      ...
      console.log(`Fetched data for Pokemon with ID: ${i}`);
